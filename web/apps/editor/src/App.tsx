 ...
 */
type View = { name: "list" } | { name: "viewer"; id: string; title: string; kind: ArtifactKind | null };
...
export function App() {
  ...
  const openDocument = useCallback((id: string, title: string, kind: ArtifactKind) => {
    setView({ name: "viewer", id, title, kind });
  }, []);
