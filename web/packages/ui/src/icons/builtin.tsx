...
export const builtinIcons: Record<IconName, IconRenderer> = {
  ...
  "align-bottom": (props) => svg({ ...props, children: <><path d="M2.5 13h11" /><rect x="3.2" y="8" width="2.2" height="4" /><rect x="6.9" y="5.5" width="2.2" height="6.5" /><rect x="10.6" y="7" width="2.2" height="5" /></> }),
  "align-center": (props) => svg({ ...props, children: <><path d="M2.5 3.5h11M4.5 6.5h7M2.5 9.5h11M4.5 12.5h7" /></> }),
  "align-middle": (props) => svg({ ...props, children: <><path d="M2.5 8h11" /><rect x="3.2" y="4" width="2.2" height="8" /><rect x="6.9" y="5.3" width="2.2" height="5.4" /><rect x="10.6" y="3" width="2.2" height="10" /></> }),
  "align-right": (props) => svg({ ...props, children: <><path d="M2.5 3.5h11M6.5 6.5h7M2.5 9.5h11M6.5 12.5h7" /></> }),
  "align-top": (props) => svg({ ...props, children: <><path d="M2.5 3h11" /><rect x="3.2" y="4" width="2.2" height="4" /><rect x="6.9" y="4" width="2.2" height="6.5" /><rect x="10.6" y="4" width="2.2" height="5" /></> }),
  ...
  "bring-forward": (props) => svg({ ...props, children: <><rect x="3" y="5.5" width="7.5" height="7.5" rx=".75" /><path d="M7.5 5V2.5M5.8 4.2 7.5 2.5l1.7 1.7M11 3.5h2v7.5" /></> }),
  "bring-front": (props) => svg({ ...props, children: <><rect x="3" y="6" width="7" height="7" rx=".75" /><rect x="6" y="3" width="7" height="7" rx=".75" /><path d="M9.5 2v-1.2M8.2 2.1 9.5.8l1.3 1.3" /></> }),
  "bg-colors": (props) => svg({
    ...props,
    viewBox: "0 0 48 48",
    strokeWidth: 4,
  ...
  "distribute-horizontal": (props) => svg({ ...props, children: <><path d="M2.5 3v10M13.5 3v10" /><rect x="4" y="5.5" width="2.1" height="5" /><rect x="6.95" y="5.5" width="2.1" height="5" /><rect x="9.9" y="5.5" width="2.1" height="5" /></> }),
  "distribute-vertical": (props) => svg({ ...props, children: <><path d="M3 2.5h10M3 13.5h10" /><rect x="5.5" y="4" width="5" height="2.1" /><rect x="5.5" y="6.95" width="5" height="2.1" /><rect x="5.5" y="9.9" width="5" height="2.1" /></> }),
  ...
  lock: (props) => svg({ ...props, children: <><rect x="3.25" y="7" width="9.5" height="6.25" rx="1" /><path d="M5.5 7V5.3a2.5 2.5 0 0 1 5 0V7M8 9.25v1.75" /></> }),
  ...
  "send-back": (props) => svg({ ...props, children: <><rect x="3" y="6" width="7" height="7" rx=".75" /><rect x="6" y="3" width="7" height="7" rx=".75" /><path d="M6.5 13.2v1.2M5.2 13.1l1.3 1.3 1.3-1.3" /></> }),
  "send-backward": (props) => svg({ ...props, children: <><rect x="5.5" y="3" width="7.5" height="7.5" rx=".75" /><path d="M5 12.5H3V5" /><path d="M8.5 11v2.5M6.8 12.3l1.7 1.7 1.7-1.7" /></> }),
  shape: (props) => svg({ ...props, children: <><rect x="2.5" y="3" width="11" height="10" rx="1" /><circle cx="5.3" cy="6" r="1" /><path d="m3 11 3.1-3 2.2 2 1.6-1.5 3.3 2.5" /></> }),
  ...
  text: (props) => svg({ ...props, children: <><path d="M3 3.5h10M8 3.5v9M5.5 12.5h5" /></> }),
  underline: (props) => svg({ ...props, children: <><path d="M4.5 2.5v5a3.5 3.5 0 0 0 7 0v-5M3 13.5h10" /></> }),
  unlock: (props) => svg({ ...props, children: <><rect x="3.25" y="7" width="9.5" height="6.25" rx="1" /><path d="M5.5 7V5.3a2.5 2.5 0 0 1 4.25-1.75M8 9.25v1.75" /></> }),
